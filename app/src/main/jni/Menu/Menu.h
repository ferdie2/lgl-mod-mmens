...
jobjectArray SettingsList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            ...
            OBFUSCATE("Category_Overlay Text"),
            OBFUSCATE("-10_Toggle_Show Overlay Text"),
            OBFUSCATE("-11_InputText_Custom Text"),
            OBFUSCATE("-12_SeekBar_Text Size_10_30"),
...
// Global variables for overlay text
static bool overlayEnabled = false;
static std::string overlayCustomText = "Mod Menu Active";
static int overlayTextSize = 16;
#ifndef MENU_H
#define MENU_H
...
// Function declarations for Menu class native methods
extern "C" {
...
// Helper functions
std::string getMenuFeatures(int menuIndex);
void processMenuSelection(int menuIndex);
